...
Scene::Scene()
{
    ...
    blinnphong = std::make_unique<ew::Shader>("assets/shaders/default_shadowmap.vs", "assets/shaders/blinnphong_shadowmap.fs");
...
void Scene::CreateDepthBuffer()
{
    ...
    {
        printf("It's not complete (depth) :(\n");
    }
...
void Scene::Render(void)
{
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, fbo);
    {
        ...
        glBindTextureUnit(1, shadow_depth);
        ...
        const auto plane_mat = glm::translate(glm::mat4(1.0), glm::vec3(0.0f, -2.0f, 0.0f));
        blinnphong->setMat4("model", plane_mat);
        blinnphong->setMat4("view_proj", view_proj);
        blinnphong->setMat4("light_proj_pos", glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, 0.1f, 100.0f) * glm::lookAt(light.position, glm::vec3(0.0), glm::vec3(0.0f, 1.0, 0.0f)));
        plane.draw();
    }
    glBindFramebuffer(GL_FRAMEBUFFER, 0);
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, shadow_fbo);
    {
        ...
        depth->setMat4("light_view_projection", glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, 0.1f, 100.0f) * glm::lookAt(light.position, glm::vec3(0.0), glm::vec3(0.0f, 1.0, 0.0f)));
...
void Scene::Debug(void)
{
    ...
    ImGui::SliderFloat("Shadow Bias", &debug.bias, -1.0f, 1.0f);
